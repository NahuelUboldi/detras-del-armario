  ...
  return (
    ...
    <div className="story-container px-3 px-md-5">
      <header className='pb-2 pb-md-5'>
        ...
        <span className="author display-5 fst-italic">- Sofia Contreras Canard</span>
      </header>
      ...
      <p>
        Recuerdo que una de las gomitas que más disfrutamos fue {data.compañerita}, una chica fina del séptimo A. La llevamos
        ...
        de lo más sutiles por innecesarias. Una vez que {data.compañerita} entró, como quien no quiere la cosa, fueron dos compañeras a
      ...
      <p>
        ...
        silla, parecíamos trapos de piso estrujados, la {data.maestra} preguntaba qué nos había pasado. Le dábamos excusas o nombrábamos
      ...
      <footer className='text-center'>
        <button className="btn btn-primary fs-4 my-3 my-md-5 align-self-center" onClick={() => setIsModalOpen(true)}>Finalizar Experimento</button>
      </footer>
