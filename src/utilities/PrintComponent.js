...
export const PrintComponent = React.forwardRef((props, ref) => {
 const [data, setData] = useState(() => {
  ...
  return (
    <div ref={ref}>
        <div className='story-container px-5 py-5'>
          <header className='pb-5'>
            <h1 className='display-1'>Detrás del Armario</h1>
            <span className='author display-5 fst-italic'>
              ~ Sofia Contreras Canard
            </span>
          </header>
          <main className='ps-5 py-5 fs-4'>
            <p>
            ...
            <p>
              Al principio, entrábamos para dibujar corazones. "{data.nombre} y {data.nombreGustaba}", escribí yo. Después dije que eso no había
            ...
            <p>
              ...
              lamía a Pappo Napolitano. Algunos teníamos el gusto firme en {data.banda} y nos repartimos las letras para escribirlo bien
            ...
            <div className='author display-5 fst-italic my-5'>
              ~ ~ ~
            </div>
          ...
          <footer className="text-center">
           <p>Detrás del armario<span className="text-color-primary fw-bold"> ~ Sofía Contreras Canard</span><br />Cuento finalista en el Premio Itaú de Cuento Digital 2020
            </p>
          </footer>
         </div>
    </div>
